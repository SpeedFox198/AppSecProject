...
# q2 = """ INSERT INTO Users VALUES ("5a851b9e-48dc-5c81-9039-720c9f0b41a6", "TestUser1", "test@user.mail", "Test1234", "54dd57bf-8b8e-5cc1-af95-14478ca84b21_padoru.png", "customer"); """
# q3 = """ INSERT INTO Customers (user_id) VALUES ("5a851b9e-48dc-5c81-9039-720c9f0b41a6"); """
# cur.execute(q1)
# cur.execute(q2)
# cur.execute(q3)
